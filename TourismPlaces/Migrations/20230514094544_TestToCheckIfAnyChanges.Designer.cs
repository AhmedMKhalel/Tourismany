...
namespace TourismPlaces.Migrations
{
    ...
    [Migration("20230514094544_TestToCheckIfAnyChanges")]
    partial class TestToCheckIfAnyChanges
    {
            ...
            modelBuilder.Entity("TourismPlaces.Data.Place", b =>
                {
                    ...
                    b.HasOne("TourismPlaces.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Places")
                        .HasForeignKey("UserId");
